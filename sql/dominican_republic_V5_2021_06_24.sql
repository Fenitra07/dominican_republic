...
CREATE TABLE IF NOT EXISTS `passager` (
  ...
  `boarding_port_departure` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `flight_number_departure` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `flight_date_departure` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `disemarkation_port_departure` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `transportation_company_departure` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `travel_purpose_departure` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `days_staying_departure` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
...
(9, 'ttt', 'tt', '2021-06-17', 'Feminine', 'test', 'test', 'test', 'true', 'ttt', 'tt', NULL, 'Select an option', '', '', NULL, 'Convention â€“ Conference', 'tttt', '', 'Select an option', 'tttt', 'ttt', 'POP - AEROPUERTO INTERNACIONAL GREGORIO LUPERON, PUERTO PLATA', '2021-06-24', 'true', 'true', 32, 46, 127, 'aa', '2021-06-17', 'aa', 'aa', '2021-06-17', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', 'Visit friends and/or family', '11', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', '2021-06-17', 'test', 'test', 'Studies', 'test'),
(10, 'aa', 'aa', '2021-06-24', 'Feminine', 'aa', 'aa', 'aa', 'true', 'aa', 'aa', NULL, 'Select an option', '', '', NULL, 'Convention â€“ Conference', 'aa', '', 'Select an option', 'aa', 'aa', 'STI - AEROPUERTO INTERNACIONAL DEL CIBAO', '2021-06-24', 'true', 'true', 33, 47, 128, 'aa', '2021-06-17', 'aa', 'aa', '2021-06-17', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', 'Visit friends and/or family', '11', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', '2021-06-17', 'test', 'test', 'Studies', 'test'),
(11, 'ss', 'ss', '2021-06-24', 'Feminine', 'ss', 'ss', 'ss', 'No', 'ss', 'ss', NULL, 'La Altagracia', 'ss', 'ss', NULL, 'Select an option', '', 'ss', 'POP - AEROPUERTO INTERNACIONAL GREGORIO LUPERON, PUERTO PLATA', '', '', 'Select an option', '', 'false', 'true', 34, 48, 129, 'aa', '2021-06-17', 'aa', 'aa', '2021-06-17', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', 'Visit friends and/or family', '11', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', '2021-06-17', 'test', 'test', 'Studies', 'test'),
(18, 'qq', 'qq', '2021-06-24', 'Feminine', 'qq', 'qq', 'qq', 'Yes', 'qq', 'qq', NULL, 'Select an option', '', '', NULL, 'Medical reasons', 'qq', '', 'Select an option', 'qq', 'qq', 'POP - AEROPUERTO INTERNACIONAL GREGORIO LUPERON, PUERTO PLATA', '2021-06-24', 'true', 'true', 41, 55, 136, 'aa', '2021-06-17', 'aa', 'aa', '2021-06-17', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', 'Visit friends and/or family', '11', 'SDQ - AEROPUERTO INTERNACIONAL DE LAS AMERICAS', 'test', '2021-06-17', 'test', 'test', 'Studies', 'test');
