...
if (!empty($_GET["id"]) || isset($Passager)) {
  $id = $_GET["id"]??$Passager;
...
<div class="row">
    <div class="col-md-12">
      ...
      <p>Please find below the invoice for the purchase of our services to obtain your E-ticket for the Dominican Republic</p>

      <div class="widget-box">
        <div class="widget-header widget-header-large">
          <h3 class="widget-title grey lighter">
            <a href="https://www.go-dominican-republic.com">
              <span style="color: #064266;">go-dominican-republic.com</span>
            </a>
          </h3>
              ...
              <div class="col-md-3">
                <div>
                  <ul class="list-unstyled spaced">
                      ...
                      <li><p><?= isset($data["noms"])? $data["noms"] : ''  ?></p></li>
                      <li><p><?= isset($data["nom_famille"])? $data["nom_famille"]: '' ?></p></li>
                      <li><p><?= isset($data["email"])? $data["email"]: '' ?></p></li>
                      <li><p><?= isset($data["numero"])? $data["numero"]: '' ?></p></li>
                    </ul>
                </div>
              </div><!-- /.col -->
            </div><!-- /.row -->
