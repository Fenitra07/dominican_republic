      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <div class="div_form_title">
            <h2 class="form_first_title">VEUILLEZ REMPLIR VOTRE FORMULAIRE DE DEMANDE D'E-TICKET POUR LA RÉPUBLIQUE DOMINICAINE</h2>
            <p class="form_paragraph">Remplissez le formulaire pour lancer la procédure de demande d'un E-ticket pour votre séjour.</p>
          </div>
          <!-- FORMULAIRE  -->
          <div>
            <?php
