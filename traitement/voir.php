                      ...
                      <p class="form_paragraph">Please provide your address</p>
                        ...
                        <div id="r_arrival" >
                          ...
                          <div id="r_yes3" >
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input disabled class="input--style-6" type="" value="<?= isset($data["day_staying"])? $data["day_staying"]: '' ?>" name="day_staying" placeholder="">
                                    </div>
                                </div>
                            </div>
                          </div>
                        ...
                        <div id="r_departure" >
                          ...
                          <div class="form-row">
                              ...
                              <div class="value">
                                  <div class="input-group">
                                      <input disabled class="input--style-6" type="" value="<?= isset($data["disembarktion_port"])? $data["disembarktion_port"]: '' ?>" name="disembarktion_port" placeholder="">
                                  </div>
                              </div>
                          </div>
                          <div class="form-row">
